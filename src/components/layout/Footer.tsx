        ...
        <div className="py-16">
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              {/* App Download Badges */}
              <div className="mt-6">
                <p className="text-background/80 text-sm mb-3">Download the app</p>
                <div className="flex flex-col space-y-2">
                  <Button variant="outline" size="sm" className="justify-start text-background border-background/20 hover:bg-background/10">
